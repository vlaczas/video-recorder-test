...
navigator.mediaDevices.getUserMedia({video: {width: {ideal: 400}, height: {ideal: 400}, frameRate: {ideal: 20}, aspectRatio: {ideal: 1}, sampleRate: {ideal: 128}, sampleSize:{ideal: 4}, noiseSuppression: true}, audio: true}).then(st => {
  stream = st
  fun()
})
